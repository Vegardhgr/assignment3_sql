...
(2, 3, 7.0, 'Pretty decent.'),
(2, 4, 6.5, 'Not as expected.'),
(3, 5, 9.5, 'Exceptional visuals!'),
(3, 6, 8.0, 'Entertaining.'),
(4, 7, 7.5, 'Good watch!'),
(4, 8, 8.5, 'Amazing experience.'),
(5, 9, 9.0, 'Masterpiece!'),
(5, 10, 9.5, 'Highly recommended!'),
(6, 11, 7.5, 'Enjoyable.'),
(6, 12, 8.0, 'Worth watching!'),
(6, 13, 8.3, 'Impressive storyline.'),
(7, 14, 8.6, 'Fantastic drama.'),
(7, 15, 8.2, 'Very entertaining!');
